...
#animation0, #animation1, #animation2, #animation3, #animation4, #animation5, #animation6, #animation7, #animation8, #animation9, #animation10, #animation11, #animation12, #animation13, #animation14, #animation15, .sign{
            background-image: url("../lengua/conector_espera.jpg");
            background-repeat: no-repeat; height: 192px;  width: 260px;
            background-size: 100%;
            -webkit-border-radius: 1000px;
	...
	<script type="text/javascript" src="<?php echo base_url()?>style/inicio/js/jquery-1.10.2.js"></script>
